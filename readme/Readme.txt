...
you can chekout my project on [Github](https://github.com/simarjot0032/functional_science) and for Versiion Control System I have used Git & Github The main file in my project is main.tsx and app.tsx all the files in the src > components folder

## Stepts to run project on local machine

-   All the required modules are already add to my project directory in
    node modules folder but you have to re install the some modedules
    from folder for that the commands are given below here:
	...
	`npm run dev` this will start the  react project on local machine at port 5173 all the
