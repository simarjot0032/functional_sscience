...
import Sample1 from "../assets/CBSE-Sample-Paper-Class-9-Science-Set-1.pdf";
import Sample2 from "../assets/CBSE-Sample-Paper-Class-9-Science-Set-2.pdf";
import Sample3 from "../assets/CBSE-Sample-Paper-Class-9-Science-Set-3.pdf";
